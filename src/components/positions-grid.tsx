              ...
              <div className="space-y-3">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    ...
                    <a
                      href={yahooQuoteUrl(position.instrument.ticker)}
                      target="_blank"
                      rel="noopener noreferrer"
                      title={`Voir ${position.instrument.ticker} sur Yahoo Finance`}
                      className="text-dash-soft mt-1 inline-flex items-center gap-1 text-[1.05rem] tracking-[-0.03em] hover:text-white hover:underline"
                    >
