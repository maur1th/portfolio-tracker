        ...
        <CardContent className="relative flex h-full flex-col gap-6 p-6">
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-2">
              <div className="text-dash-faint text-[11px] font-medium uppercase tracking-[0.24em]">
                Compte
              </div>
            ...
            <Badge
              variant="outline"
              className="bg-dash-chip border-dash-chip-border text-dash-strong px-3 py-1 text-[0.95rem]"
            >
          ...
          <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_170px] lg:items-end">
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <div className="text-dash-muted text-sm">Gain/Perte</div>
                  <div
              ...
              <div className="text-dash-muted flex items-center gap-3 text-sm">
                <span>
                  {summary.positionCount} position{summary.positionCount > 1 ? "s" : ""}
                </span>
                <span className="bg-dash-dot h-1 w-1 rounded-full" />
